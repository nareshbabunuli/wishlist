...
Route::group(['namespace' => 'Admin'], function () {
    ...
    Route::get('admin_wishlist/{admin_id}/{product_id}/', 'AdminWishlistController@store');
    Route::get('admin_wishlist/{id}/', 'AdminWishlistController@destroy');
    Route::resource('admin_wishlist', 'AdminWishlistController');
});
